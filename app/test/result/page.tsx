    ...
    <>
      <div className={`relative min-h-screen overflow-hidden bg-gradient-to-b ${theme.bg} py-8 px-4`}>
        ...
        <div className="pointer-events-none absolute inset-0" aria-hidden="true">
          <div className="absolute left-[2%] top-[20%] w-20 opacity-15"><Image src={Coral} alt="" width={80} height={60} className="object-contain" /></div>
          <div className="absolute right-[6%] top-[15%] w-16 opacity-10"><Image src={Starfish} alt="" width={64} height={64} className="object-contain" /></div>
          ...
          <div className="absolute bottom-[20%] right-[4%] w-16 opacity-10"><Image src={Coral} alt="" width={80} height={60} className="object-contain scale-x-[-1]" /></div>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-lg space-y-6">
          ...
          {/* Main result card */}
          <div className={`${theme.cardBg} rounded-3xl border-2 ${theme.cardBorder} p-6 shadow-2xl`}>
            {/* Character name badge */}
            <span className="inline-block rounded-full bg-[#FFD15A] px-4 py-1 font-dynapuff text-sm font-bold text-[#0A3D62]">
              {archetype.character}
            </span>

            {/* Archetype title */}
            <h1 className="mt-3 font-dynapuff text-3xl font-bold text-white" style={{ WebkitTextStroke: "1.5px rgba(0,0,0,0.15)" }}>
              {archetype.name}
            </h1>

            {/* Mascot image */}
            <div className="relative my-4 flex justify-center">
              <div className="relative h-48 w-full overflow-hidden rounded-2xl bg-gradient-to-br from-white/10 to-white/5">
                <Image
                  src={theme.mascot}
            ...
            <div className="flex flex-wrap gap-2">
              {archetype.traitsEn.map((t) => (
                <span key={t} className={`${theme.traitBg} ${theme.traitText} rounded-full px-4 py-1 font-dynapuff text-xs font-semibold`}>
                  {t}
                </span>
              ))}
            </div>
            ...
            {/* Motto */}
            <p className={`mt-5 font-dynapuff text-lg font-bold ${theme.accent}`} style={{ WebkitTextStroke: "0.5px rgba(0,0,0,0.1)" }}>
          ...
          {/* Share + Download */}
          <div className="rounded-3xl bg-white/95 p-6 shadow-2xl">
            <h3 className="font-dynapuff text-center text-sm font-bold text-[#0A3D62]">Share your OCEAN Archetype</h3>
            <div className="mt-4 flex justify-center gap-3">
              {/* Facebook */}
              <button onClick={shareFacebook} className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#0A3D62] text-[#0A3D62] transition-all hover:bg-[#0A3D62] hover:text-white active:scale-95">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </button>
              {/* Instagram */}
              <button onClick={shareInstagram} className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#0A3D62] text-[#0A3D62] transition-all hover:bg-[#0A3D62] hover:text-white active:scale-95">
              ...
              {/* LinkedIn */}
              <button onClick={shareLinkedin} className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#0A3D62] text-[#0A3D62] transition-all hover:bg-[#0A3D62] hover:text-white active:scale-95">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
              </button>
              {/* Copy link */}
              <button onClick={shareCopyLink} className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#0A3D62] text-[#0A3D62] transition-all hover:bg-[#0A3D62] hover:text-white active:scale-95">
          ...
          <div className="flex justify-center">
            <Link href="/test" className="rounded-full bg-white px-8 py-3 font-dynapuff font-bold text-[#0A3D62] shadow-lg transition-all hover:bg-gray-100 active:scale-95">
              Retake Test
            </Link>
          </div>
        </div>
