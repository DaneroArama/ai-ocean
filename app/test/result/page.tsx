  ...
  return (
    <>
      <div className="relative min-h-screen overflow-hidden bg-[#0CB6FF] py-6 px-4 pt-20">
        ...
        {/* Home button */}
        <div className="absolute top-10 left-10 flex justify-center pb-6">
          <Link href="/"
                className="flex h-14 w-14 items-center justify-center rounded-full bg-[#0A3D62] text-white shadow-[3px_3px_0_0_rgba(0,0,0,0.2)] transition-all hover:translate-y-[-2px] hover:shadow-[4px_5px_0_0_rgba(0,0,0,0.2)] active:translate-y-[1px] active:shadow-[1px_1px_0_0_rgba(0,0,0,0.2)]">
        ...
        <div className="relative z-10 mx-auto max-w-lg space-y-5">
          ...
          <div className={`${theme.cardBg} relative flex items-center rounded-3xl pb-0 shadow-xl mt-20`}
            ...
            <div className="relative z-10 h-30 md:h-40 p-6">
              <p className={`font-quicksand text-sm ${theme.subtitle}`}
                 style={{textShadow: "1px 1px 0 rgba(0,0,0,0.2)"}}>You are</p>
              <h1
              ...
              <p className={`font-quicksand text-base ${theme.subtitle}`}
                 style={{textShadow: "1px 1px 0 rgba(0,0,0,0.2)"}}>({archetype.name})</p>
            </div>
          ...
          <div className="relative">
            {/* Tab label */}
            <div
              className="inline-block rounded-t-2xl border-t border-l border-r border-white/30 bg-white/20 px-6 py-2 backdrop-blur-sm">
            ...
            <div className="-mt-px rounded-r-2xl rounded-bl-2xl border border-white/20 bg-transparent backdrop-blur-sm">
              {/* Inset inner box */}
              <div
                className="rounded-r-2xl rounded-bl-2xl border border-white/10 bg-white/5 p-5 shadow-[inset_0px_0px_20px_5px_rgba(255,255,255,10)]">
